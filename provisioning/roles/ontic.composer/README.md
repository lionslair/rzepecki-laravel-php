# Ontic Composer ![Status](https://img.shields.io/badge/project-maintained-brightgreen.svg)
...
This role installs Composer on RedHat/CentOS and Debian/Ubuntu Linux servers.
...
```
$ ansible-galaxy install ontic.composer
```
...
```yml
- src: git+https://github.com/ontic/ansible-role-composer.git
  version: master
  name: ontic.composer
```
